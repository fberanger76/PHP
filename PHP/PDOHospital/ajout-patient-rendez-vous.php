    ...
    <div class="container">
        <div class="card">
            ...
            <form method="POST">
                ...
                <button type="submit" name="submitPatientAndAppointment" class="btn btn-dark ms-3 mt-3 mb-3">Enregistrer</button>
    ...
    <script>
        if (<?= $addSuccess ?>) {
            Swal.fire({
                icon: 'success',
                title: 'Bravo !',
                text: 'Le patient et son rdv ont bien été rajoutés !',
