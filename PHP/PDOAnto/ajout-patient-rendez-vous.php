<?php
require 'controllers/controllerBoth.php';
    ...
    <div class="container">
        <div class="card">
            <div class="card-header text-center">
                <h1><i class="fas fa-hospital-user"></i> Enregistrement du patient et du rendez-vous</h1>
            </div>
            <form method="POST">
                <div class="m-3">
                ...
                <button type="submit" name="submit" class="btn btn-dark ms-3 mt-3 mb-3">Enregistrer</button>
    ...
    <script>
        if (<?= $addSuccess ?>) {
            Swal.fire({
                icon: 'success',
                title: 'Bravo !',
                text: 'Le patient et le rendezvous ont bien été rajouté !',
