		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<?php if (have_posts()) {
							$articles = get_posts("numberposts=-1&offset=$debut");
							foreach($articles as $post) : setup_postdata($post) ?>
						
											<article class="post">
												<header>
													<div class="title">
														<h2><a href="<?= get_the_permalink(get_the_ID()); ?>"><?php the_title(); ?></a></h2>
														<p><?php the_tags(); ?></p>
													</div>
													<div class="meta">
														<time class="published"><?php the_time("d-F-Y"); ?></time>
														<a href="<?= get_author_posts_url(get_the_author_ID()); ?>" class="author"><span class="name"><?php the_author() ?></span><?= get_avatar(get_the_author_ID()); ?></a>
													</div>
												</header>
												...
												<footer>
													...
													<ul class="stats">
														<li><a href="<?= get_category_link(get_the_category()); ?>"><?php the_category();?></a></li>
...
<?php while ($recentPosts->have_posts()) : $recentPosts->the_post(); ?>
										<article class="mini-post">
											<header>
												...
												<time class="published"><?php the_time("d-F-Y"); ?></time>
												<a href="#" class="author"><span class="name"><?php the_author(); ?></span><?= get_avatar(get_the_author_ID()); ?></a>
											</header>
											<a href="" class="image"><?php the_post_thumbnail(); ?></a>
										</article>
										<?php endwhile; ?>
