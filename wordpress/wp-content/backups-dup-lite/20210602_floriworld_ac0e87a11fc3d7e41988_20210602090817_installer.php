...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210602_floriworld_ac0e87a11fc3d7e41988_20210602090817_archive.zip';
	const ARCHIVE_SIZE		 = '77111159';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ac0e87a-02090817';
    const SECONDARY_PACKAGE_HASH = '20bd134-02090817';
	const VERSION			 = '1.4.1';
